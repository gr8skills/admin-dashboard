...
class CreateCMSAboutUsLeadershipsTable extends Migration
{
    /**
     * Run the migrations.
     *
...
Principal (Boarding School)',
        ...
        DB::table('c_m_s_about_us_leaderships')->truncate();
        DB::table('c_m_s_about_us_leaderships')->insert($defaultSettings);
    }
    ...
    {
        Schema::dropIfExists('c_m_s_about_us_leaderships');
    }
}
